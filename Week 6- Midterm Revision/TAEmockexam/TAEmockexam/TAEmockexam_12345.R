...
# WRITE YOUR ANSWER HERE: correlation = -0.778  
...
# WRITE YOUR ANSWER HERE: The following variables are significant: weight, year, origin. The adjusted-R^2 value is 0.8182. 
