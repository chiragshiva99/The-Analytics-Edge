...
# No. Out-of-bag error is obtain through bagging.. which is obtain through bootstrapping. 
# As CART does not involve bootstrapping, we can't obtain OOB error.
...
varImpPlot(forest) #check the highest variable
importance(forest)
